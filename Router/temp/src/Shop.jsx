        ...
        <div >
            ...
            <div className="d-md-flex">
                ...
                <div className="d-flex flex-column gap-3">
                    ...
                    <div>
                        ...
                        <div className="d-md-flex gap-3 container">
                            <div className="d-flex justify-content-center">
                                <div>
                                    ...
                                    <p className="p1name price">1kg</p>
                                </div>
                            </div>
                            ...
                            <div className="d-flex justify-content-center">
                                <div>
                                    ...
                                    <p className="p1name price">2kg</p>
                                </div>
                            </div>
                ...
                <div className="container">
                    <div className="grid3 ">
                        <h2 className="shopfnt save">Save 10% Dog's Food</h2>
                    </div>
                </div>
            </div>
            ...
            <div className="container mt-5">
                <div className="grid4 d-md-flex gap-5 justify-content-evenly">
                    ...
                    <p className="p1name price text-light">Nam libero tempore, cum soluta nobis est eligendi</p>

                    <h2 className="shopfnt text-light top-0">Animale</h2>
                    <p className="p1name price">Rs.999</p>

                    <div className="d-flex justify-content-center">
                        <button type="button" className="dealbtn">SHOP NOW</button>
                    </div>
                    </div>
                </div>
            </div>

            <div className="wave mt-5">
        </div>
        <div className="bgblk">
            <div>
